...
From this we know that `42` will not be a finance-related category. This is the power of the system: you know where you absolutely should _not_ bother looking.
...
# Let's have some fun with emoji

<img
  src="/img/emoji-chaos/emoji-1-chaos-1x.png"
  srcset="/img/emoji-chaos/emoji-1-chaos-2x.png 2x"
  alt="A rough circle of emoji: there are red, blue, and green emoji of all kinds, and they're arranged in a jumbled mess."
  width="343"
  height="343"
  loading="lazy"
  decoding="async"
