...
import Terminal from "/src/components/Terminal/Terminal.astro";
...
Thousands of emails. Hundreds of files. File structures created on a whim, six layers deep. Duplicated and lost content, hours wasted trying to find it.

**We thought search would save us from this madness. We were wrong.**
...
**We call these buckets your <u>areas</u>.**

An area might be `Finance` or `Project management`.

---

# Step 2: In each area, divide in ten again

Go through each of your new **<u>areas</u>** and repeat the process.

**This creates your <u>categories</u>**.

A category within the `Finance` area might be `Tax Returns`.

A category within `Project management` might be `Schedule`.
...
What's a category? It's just a collection of stuff. Book drafts. Travel itineraries. Lease agreements. Test reports. Contracts.
...
Let's say `10-19` is our `Finance` area.

Category `11` might be `Tax returns`, `12 Payroll`, and so on.
...
<div class="jdnumbers-large">
  <code style="padding: 0.5rem 0.75rem;">42.18</code>&nbsp;&nbsp;
  <code style="padding: 0.5rem 0.75rem;">12.03</code>&nbsp;&nbsp;
  <code style="padding: 0.5rem 0.75rem;">63.17</code>
</div>
...
The category's number tells you which area it's in. If your category starts with the digit `1`, that's something to do with `Finance`.
...
<img
  alt="Screenshot of a macOS Finder window showing a hierarchical folder structure."
  src="/src/pages/10-19_concepts/11_core/img/11.01_finder-sample-company-expanded.png"
  srcset="/src/pages/10-19_concepts/11_core/img/11.01_finder-sample-company-expanded.png 2x"
/>
...
"Hey Kristy, where can I find the payroll schedule?"<br />
"Twelve dot oh-three."
...
Put the Johnny.Decimal number [in your email subject](/10-19_concepts/12_advanced/12.01_managing_email) and you've instantly categorised everything. Your colleagues will think you have mystical powers because you'll actually be able to find email again.
...
Tab completion becomes a joy when your folders start with structured, predictable numbers. Build a [small Bash script](/10-19_concepts/12_advanced/12.02_working_at_the_command_line) to pop you in to any folder instantly:
...
By now you either [see the power of this and want more](/concepts/), or you're [confused and sad](https://start.duckduckgo.com/?q=dogs+wearing+clothes&iar=images&iax=images&ia=images&kp=1).
