...
Thousands of emails. Hundreds of files. File structures created on a whim, six layers deep. Duplicated content, lost content. **We thought search would save us from this nightmare, but we were wrong.**
...
It's worth mentioning at this point that **all of this is [free](/00-09_site_administration/01_about/01.02_licence),** and it's possible to implement it without any additional tools.
