...
<img
  ...
  src="/img/11.01_finder-sample-company-expanded.png"
  srcset="/img/11.01_finder-sample-company-expanded.png 2x"
/>
...
Tab completion becomes a joy when your folders start with structured, predictable numbers. Or use a [small shell script](/10-19_concepts/12_advanced/12.02_working_at_the_command_line) to pop you in to any folder instantly:
...
By now you either [see the power of this and want more](/10-19_concepts/11_core/11.02_areas_and_categories), or you're [confused and sad](https://duckduckgo.com/?q=chickens+on+the+beach&t=osx&iax=images&ia=images).
