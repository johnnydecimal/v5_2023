...
Press APPLE+space to bring up <a href="https://support.apple.com/en-au/HT204014">Spotlight</a>. Type a Johnny.Decimal number. Press Return.
...
Tab completion becomes a joy when your folders start with structured, predictable numbers. Build a LINK to /concepts/working-at-the-terminal/ small Bash script to pop you in to any folder instantly:
