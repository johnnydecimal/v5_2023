...
This is all a waste of time if it doesn't help you find things **quicker** and with **less stress** than you can today.
...
We can further improve discoverability by using [an index](/10-19_concepts/11_core/11.05_the_index), which we talk about on the next page.
